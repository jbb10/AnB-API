...
ofmc:	$(SRCFILES) $(GENERATED)
	ghc -XNoMonomorphismRestriction -XScopedTypeVariables -fspec-constr-count=5 -static -package base --make -O2 Main.hs -o ofmc
